...
class MyTheme {
  ...
  static const Color accent = Color(0xFF00E600);
  static const Color accent50 = Color(0x7700E600);
  static const Color accent80 = Color(0xAA00E600);
  ...
  static const Color button = Color(0xFF002244);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: const Color(0xFF002244), secondary: accent, background: grayBg),
...
Future<bool> setServerConfig(
  ...
  // [Zero-Trust] Amputação da atualização de rede via API/Clipboard para evitar overwrite da KEY
